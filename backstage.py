...
class Gybackstage():
	...
	def Clickload(self):
		...
		#组织管理//*[@id="div_contents"]/div[5]/div[5]/div[2]/div[1]/div[2]/table/tbody/tr[1]/td[2]/div
	def Organize(self):
		...
		while y < 3:
			...
			if y==0 :
				if '提问审核' in report:
					...
					print("提问审核检测失败！请检查系统!")
			elif y==1:
				if '回答审核' in report:
					print('回答审核检测成功！')
				else:
					print("回答审核检测失败！请检查系统！")
			else :
				if "提问标签" in report: 
					print('提问标签检测成功！')
				else:
					print("提问标签检测失败！请检查系统！")	
			t.sleep(2.0)
			y+=1
	...
	def count(self):
		...
		if '统计数据' in report:
			...
			print("统计数据检测失败！请检查系统！")

		#知识竞赛/html/body/div/div[2]/div/ul/li[1]/dl
	def knowledge(self):
		driver=self.driver
